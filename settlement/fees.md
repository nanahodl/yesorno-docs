...
The factor _p × (1 − p)_ gives the curve its shape. It peaks at _p = 0.50_ and tapers off toward both extremes:
...
Before you confirm, the panel shows an **Est. Fee** calculated at the **highest possible rate** (fully taker at _p = 0.50_). The **actual fee is determined at match time** based on the fill price and the market's parameters — so the final amount is **at most** the estimate, usually less.
