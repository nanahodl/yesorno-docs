...
> Buy **YES** shares on *"Will BTC reach $100k this week?"* at **15¢** each.
> The price implies a **15% chance** of the outcome. If it happens, each share redeems for **$1.00** — about a **6.7× return** ($1.00 ÷ $0.15).
> If it doesn't, the shares are worth **$0** after resolution.

## How a Share Works

Every market on Yes/No is fully collateralized: **1 YES + 1 NO = $1.00 USDC**.

![](../assets/diagrams/get-started_what-is-yesorno_1.svg)
...
![](../assets/diagrams/get-started_what-is-yesorno_2.svg)
...
* [Making Your First Trade](first-trade.md) — Get trading in minutes.
